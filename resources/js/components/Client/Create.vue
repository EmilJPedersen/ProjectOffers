    ...
    methods: {
        selectResult(result) {
            ...
            const husnummer =
                ...
                (address.husnummerTil ? "-" + address.husnummerTil : "");
            const bogstav = address.bogstavFra
                ? address.bogstavFra +
                  (address.bogstavTil ? "-" + address.bogstavTil : "")
                : "";
            const streetDetails =
                husnummer +
                bogstav +
                ...
                " " +
                (address.sidedoer ? address.sidedoer : "");

            this.name = result.virksomhedMetadata.nyesteNavn
